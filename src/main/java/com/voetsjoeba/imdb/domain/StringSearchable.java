...
/**
 * The most basic and commonly used {@link Searchable}. Provides a
 * straightforward way of using strings or the string representations of objects
 * where {@link Searchable}s are required.
 * 
 * @author Jeroen
 */
